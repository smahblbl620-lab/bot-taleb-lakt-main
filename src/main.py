    ...
    async def input_handler(event):
        ...
        # إضافة حساب - رقم الهاتف
            ...
            try:
                ...
                if 'App' in _tname:
                    _ch, _hint = 'تطبيق تيليجرام', "الكود الآن **داخل تطبيق تيليجرام للحساب المُضاف نفسه** → محادثة **Telegram** الرسمية — افتحها وانسخ الكود."
                elif 'Sms' in _tname:
                    _ch, _hint = 'رسالة SMS', "تيليجرام أرسل الكود **رسالة SMS على الرقم نفسه** — يحدث تلقائياً لأن الحساب غير مفتوح في أي جهاز (هذا قرار من تيليجرام مباشرة لا يمكن تغييره)."
                elif 'Call' in _tname or 'Flash' in _tname:
                    _ch, _hint = 'مكالمة هاتفية', "تيليجرام سيتصل **على الرقم نفسه** وينطق الكود صوتياً — لأن الحساب غير مفتوح في أي جهاز."
                else:
                    _ch, _hint = 'غير محددة', "افحص تطبيق تيليجرام للحساب المُضاف (محادثة **Telegram** الرسمية) ورسائل الرقم."
